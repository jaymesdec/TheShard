...
import * as todoListsRoute from '../src/app/api/todo-lists/route.js';
import * as todoListByIdRoute from '../src/app/api/todo-lists/[id]/route.js';
import * as todoListItemsRoute from '../src/app/api/todo-lists/[id]/items/route.js';
...
mountApiRoute('/todo-lists', todoListsRoute as RouteModule);
mountApiRoute('/todo-lists/:id/items', todoListItemsRoute as RouteModule);
